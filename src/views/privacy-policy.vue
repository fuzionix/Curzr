<template>
  <section id="privacy-policy" class="privacy-policy document">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Curzr.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Curzr, accessible from
            <a
              href="https://curzr.com"
